      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text('Rafood', style: TextStyle(fontFamily: 'Montserrat', color: Colors.black, fontWeight: FontWeight.bold, fontSize: 25.0)),
                SizedBox(width: 10.0),
                Text('Enak & Lezat', style: TextStyle(fontFamily: 'Montserrat', color: Colors.white, fontSize: 25.0))
              ],
            ),
          ),
                ...
                Padding(
                    ...
                    child: Container(
                        ...
                        child: ListView(children: [
                          _buildFoodItem('assets/mie1.jpg', 'Mie Goyeng', '\Rp.10000'),
                          _buildFoodItem('assets/bakso.jpg', 'Mbakso', '\Rp.7000'),
                        ]))),
                Row(
